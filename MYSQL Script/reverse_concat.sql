...
CREATE PROCEDURE explode_table(bound VARCHAR(255))
  ...
  BEGIN
    ...
    DROP TEMPORARY TABLE IF EXISTS bpi_2013.tablelast;
    CREATE TEMPORARY TABLE bpi_2013.tablelast(
    ...
    OPEN cur1;
      read_loop: LOOP
        ...
        WHILE i <= occurance DO
          ...
          INSERT INTO bpi_2013.tablelast VALUES (A,splitted_value);
          SET i = i + 1;
        END WHILE;
      END LOOP;

      SELECT distinct id,value FROM bpi_2013.tablelast;
    CLOSE cur1;
  END; $$