	...
	public Connection connect = null;
	 ...
	 public void readDataBase(ArrayList<String> relation) throws Exception {
		    try {
		      ...
		      statement.executeUpdate("CREATE TABLE parallel(eventA varchar(50),eventB varchar(50))");
            for(String s:relation)
            {
          	  ...
          	  String g[]=s.split("<-"); 
          	  statement1.executeUpdate("INSERT INTO parallel(eventA,eventB) VALUES ('"+g[0]+"','"+g[1]+"')");
              statement1.close();
            }
            }
		    } catch (Exception e) {
